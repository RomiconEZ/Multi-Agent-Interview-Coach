...
- Повтори активный вопрос дословно.
</rule>
...
2. Повтори свой последний технический вопрос ДОСЛОВНО.
...
3. Если активный вопрос НЕ закрыт → повтори ЕГО ЖЕ дословно.
...
- Повтори вопрос максимум 2 раза.
- Если после 2 повторов нет ответа — скажи краткий правильный ответ и \
