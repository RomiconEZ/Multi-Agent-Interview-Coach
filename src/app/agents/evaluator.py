...
EVALUATOR_SYSTEM_PROMPT = """Ты - Evaluator Agent (Агент-Оценщик) в системе технического интервью.

Твоя роль: сформировать детальный финальный фидбэк по результатам интервью.
...
Отвечай СТРОГО в формате JSON:
{
  ...
  "soft_skills_review": {
    ...
    "clarity_details": "детали",
    "honesty": "описание честности",
    "honesty_details": "детали",
    "engagement": "описание вовлечённости",
    "engagement_details": "детали"
  },
  "roadmap": {
    "items": [
